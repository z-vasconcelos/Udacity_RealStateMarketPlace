...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI (uint256 tokenId, string memory tokenUri) internal returns (string memory) {
        ...
        _tokenURIs[tokenId] = usingOraclize.strConcat(_baseTokenURI, tokenUri, usingOraclize.uint2str(tokenId));
    }

    function changeBaseTokenUri (string calldata newBaseTokenUri) external onlyOwner {
